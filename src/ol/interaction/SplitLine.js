/**
 * @module ol/interaction/SplitLine
 */
 ...
 * @enum {string}
 */
const SplitlineEventType = {
  /**
   * Triggered upon feature modification start
   * @event SplitlineEvent#splitstart
   * @api
   */
  SPLITSTART: 'splitstart',
  /**
   * Triggered upon feature modification end
   * @event SplitlineEvent#splitend
   * @api
   */
  SPLITEND: 'splitend',
};
 ...
 */
export class SplitlineEvent extends Event {
  /**
   * @param {SplitlineEventType} type Type.
 ...
 * @fires SplitlineEvent
 * @api
 */
class SplitLine extends PointerInteraction {
  /**
  ...
  insertVertex_(segmentData, vertex) {
    ...
    const linea_resultante_1 = new Feature({});
    const linea_resultante_2 = new Feature({});
    ...
    switch (geometry.getType()) {
      ...
      case 'LineString':
        ...
        const coords1 = coordinates.slice(0, index + 2);
        const coords2 = coordinates.slice(index + 1);
        linea_resultante_1.setGeometry(new LineString(coords1));
        linea_resultante_2.setGeometry(new LineString(coords2));
        this.segmentos_result.push(linea_resultante_1);
    ...
    for (uid in segmentsByFeature) {
      ...
      switch (geometry.getType()) {
        case 'MultiLineString':
          ...
          break;
        case 'LineString':
          const coords1 = coordinates.slice(0, index + 1);
          const coords2 = coordinates.slice(index);
          linea_resultante_1.setGeometry(new LineString(coords1));
          linea_resultante_2.setGeometry(new LineString(coords2));
          this.segmentos_result.push(linea_resultante_1);
          this.segmentos_result.push(linea_resultante_2);
